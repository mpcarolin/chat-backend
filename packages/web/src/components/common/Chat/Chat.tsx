...
export const Chat = () => {
    const { messages, sendMessage, loading } = useChat({
        initialMessages: [
            ...
            userMessage("Just do what i want"),
        ]
    });
    ...
    return (
        <div className="chat-root">
            <div className="chat-messages">
                ...
                {loading && <Message position="left" content="..." />}
            </div>
            <form className="chat-form" onSubmit={e => {
                ...
                />
                <button type="submit" disabled={!pendingMessage} className="submit-button">
                    <SendMessageIcon />
                </button>
            </form>
        </div>
...
const Message = ({ position, content, loading }: {
    position: "left" | "right",
    content: string,
    loading?: boolean
}) => {
